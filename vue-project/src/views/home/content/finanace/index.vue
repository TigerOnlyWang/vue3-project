<template>
  <el-row v-if="isShow" style="top: 50%;left: 50%;"><p>提交成功！！</p></el-row>
  <el-form v-else :model="formData" ref="vForm" :rules="rules" label-position="left" label-width="150px" size="default"
    @submit.prevent>
    ...
    <el-form-item label="" label-width="0" prop="radio63396" class="label-right-align">
      <el-radio-group v-model="formData.radio63396">
        <el-radio v-for="(item, index) in radio63396Options" :key="index" :label="item.value" :disabled="item.disabled"
          style="{display: block}">{{ item.label }}</el-radio>
      </el-radio-group>
    </el-form-item>
    <div class="static-content-item">
    ...
    <el-form-item label="" label-width="0" prop="radio113860" class="label-right-align">
      <el-radio-group v-model="formData.radio113860">
        <el-radio v-for="(item, index) in radio113860Options" :key="index" :label="item.value" :disabled="item.disabled"
    ...
    <el-form-item label="" label-width="0" prop="radio74071" class="label-right-align">
      <el-radio-group v-model="formData.radio74071">
        <el-radio v-for="(item, index) in radio74071Options" :key="index" :label="item.value" :disabled="item.disabled"
          style="{display: inline}">{{ item.label }}</el-radio>
      </el-radio-group>
    </el-form-item>
    <div class="static-content-item">
    ...
    <el-form-item label="" label-width="0" prop="radio88180" class="label-right-align">
      <el-radio-group v-model="formData.radio88180">
        <el-radio v-for="(item, index) in radio88180Options" :key="index" :label="item.value" :disabled="item.disabled"
          style="{display: inline}">{{ item.label }}</el-radio>
      </el-radio-group>
    </el-form-item>
    <div class="static-content-item">
    ...
    <el-form-item label="" label-width="0" prop="radio71802" class="label-right-align">
      <el-radio-group v-model="formData.radio71802">
        <el-radio v-for="(item, index) in radio71802Options" :key="index" :label="item.value" :disabled="item.disabled"
          style="{display: inline}">{{ item.label }}</el-radio>
      </el-radio-group>
    </el-form-item>
    <div class="static-content-item">
    ...
    <el-form-item label="" label-width="0" prop="radio92444" class="label-right-align">
      <el-radio-group v-model="formData.radio92444">
        <el-radio v-for="(item, index) in radio92444Options" :key="index" :label="item.value" :disabled="item.disabled"
          style="{display: inline}">{{ item.label }}</el-radio>
      </el-radio-group>
    </el-form-item>
    <div class="static-content-item">
